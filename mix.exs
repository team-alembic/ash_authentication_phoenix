      ...
      docs: fn ->
        [
          ...
          extras: [
            ...
            {"documentation/tutorials/totp.md", title: "TOTP Authentication"},
            {"documentation/tutorials/totp-2fa.md", title: "TOTP as Second Factor"},
            {"documentation/topics/authentication-metadata.md", title: "Authentication Metadata"}
          ],
          redirects: %{
  ...
  def package do
    [
      ...
      links: %{
        ...
        "GitHub" => "https://github.com/team-alembic/ash_authentication_phoenix",
        "Changelog" =>
          "https://github.com/team-alembic/ash_authentication_phoenix/blob/main/CHANGELOG.md",
        "REUSE Compliance" =>
